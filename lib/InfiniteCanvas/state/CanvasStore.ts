...
import { CAMERA_ANGLE } from "../core/constants";
...
export default class CanvasStore {
  ...
  private static isCameraInBounds(
    ...
    //   this.aspect
    // );
    // const isXInBounds = x >= 0 && x <= this.data.container.width;
    // const isYInBounds = y >= 0 && y <= this.data.container.height;
